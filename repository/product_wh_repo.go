...
type ProductWhRepo interface {
	GetAll() any
	GetById(id int) any
	GetByName(name string) (*entity.ProductWh, error)
	Create(newProduct *entity.ProductWh) (*entity.ProductWh, error)
...
func (r *productWhRepo) GetByName(name string) (*entity.ProductWh, error) {
	var productInDb entity.ProductWh
...
func (r *productWhRepo) Create(newProduct *entity.ProductWh) (*entity.ProductWh, error) {
	...
	if err != nil {
		log.Println(err)
		return &entity.ProductWh{}, fmt.Errorf("failed to create product")
	}
